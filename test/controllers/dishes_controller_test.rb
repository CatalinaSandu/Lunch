...
class DishesControllerTest < ActionController::TestCase
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post :create, dish: { dish_title: @dish.dish_title, dish_type: @dish.dish_type, menu_id: @dish.menu_id }
    end
  ...
  test "should update dish" do
    patch :update, id: @dish, dish: { dish_title: @dish.dish_title, dish_type: @dish.dish_type, menu_id: @dish.menu_id }
    assert_redirected_to dish_path(assigns(:dish))
  end
